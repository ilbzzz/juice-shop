...
export const isRedirectAllowed = (url: string) => {
  ...
  for (const allowedUrl of redirectAllowlist) {
    allowed = allowed || (!!url && (url === allowedUrl || url.startsWith(allowedUrl + '/') || url.startsWith(allowedUrl + '?') || url.startsWith(allowedUrl + '#'))) // vuln-code-snippet vuln-line redirectChallenge
  }
  return allowed
}
